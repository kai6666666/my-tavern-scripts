...
export const EMOJI_MAP: [RegExp, string][] = [
  ...
  [/埃辛诺斯战刃/, 'ti:swords'],
  [/灰烬使者/, 'ti:sword'],
  [/紫金葫芦|掌天瓶|玉净瓶/, 'ti:bottle'],
  [/风月宝鉴/, 'fa:eye'],
  [/如意电话亭/, 'fa:phone'],
  [/金箍棒/, 'fa:gavel'],
  [/闪耀的偏方三八面体|避水珠/, 'fa:gem'],
  [/死灵之书/, 'fa:book-skull'],
  [/焚决/, 'fa:fire'],
  [/超电磁炮/, 'fa:bolt'],
  [/at立场/, 'fa:shield-halved'],
  [/rtx 5090|5090/, 'fa:microchip'],
  [/金坷垃/, 'ti:plant'],
  [/白色相簿/, 'fa:book'],
  [/传国玉玺/, 'fa:stamp'],
  [/葵花宝典/, 'fa:book-open'],
  ...
  [/手电筒/, 'fa:lightbulb'],
  [/会员卡/, 'fa:id-card'],
  [/玉座金佛/, 'fa:place-of-worship'],
  [/马良的笔|阿勒苏霍德之笔/, 'fa:pencil'],
  [/变声器/, 'fa:microphone'],
  [/麻醉针/, 'ti:needle'],
  [/黄金马桶/, 'fa:toilet'],
  [/轮椅/, 'fa:wheelchair'],
